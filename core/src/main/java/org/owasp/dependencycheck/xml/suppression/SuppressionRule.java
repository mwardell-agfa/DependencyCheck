...
public class SuppressionRule {
    ...
    boolean suppressedBasedOnScore(Vulnerability v) {
        ...
        if (hasCvssV2Below() || hasCvssV3Below() || hasCvssV4Below()) {
            ...
            boolean suppressVuln = cvssV2CheckSuppressing && cvssV3CheckSuppressing && cvssV4CheckSuppressing;

            System.out.printf("AXEHM: CVE=%s, V2(s=%.1f, t=%.1f), V3(s=%.1f, t=%.1f), V4(s=%.1f, t=%.1f)\n       cvssV2CheckSuppressing=%b, cvssV2CheckSuppressing=%b, cvssV4CheckSuppressing=%b\n       suppressVuln=%b%n",
                    cve,
                    v2Score, v2SuppressionThreshold,
                    v3Score, v3SuppressionThreshold,
                    v4Score, v4SuppressionThreshold,
                    cvssV2CheckSuppressing, cvssV3CheckSuppressing, cvssV4CheckSuppressing, suppressVuln);
